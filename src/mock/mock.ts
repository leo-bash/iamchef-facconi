...
export const fallbackRecipeMock: RecipeInterface = {
  id: 1,
  title: "Sushi Rolls",
...
export const recipesMock: RecipeInterface[] = [
  {
    id: 1,
    title: "Sushi Rolls",
    ...
    extendedIngredients: [
      {
        ...
        image: "salmon.jpg",
        measures: {
          metric: { amount: 200, unitLong: "grams", unitShort: "g" },
          us: { amount: 7, unitLong: "ounces", unitShort: "oz" },
        },
        meta: ["raw"],
        name: "salmon fillet",
        original: "200g salmon fillet, raw",
      ...
      },
      {
        ...
        name: "nori sheets",
        original: "2 nori sheets",
        originalName: "nori sheets",
        unit: "sheets",
      },
    ],
    summary:
      "Classic Japanese sushi rolls with salmon, rice, cucumber, and nori.",
    winePairing: null,
  },
  {
    id: 2,
    ...
    extendedIngredients: [
      ...
      },
      {
        ...
        image: "cream.jpg",
        measures: {
          metric: { amount: 150, unitLong: "ml", unitShort: "ml" },
          us: { amount: 5, unitLong: "oz", unitShort: "oz" },
        },
        name: "cream",
        original: "150ml cream",
        originalName: "cream",
        unit: "ml",
      },
    ],
    summary:
      "Tender chicken in creamy and spicy tomato sauce, a popular Indian dish.",
    winePairing: null,
  },
  {
    id: 3,
    ...
    extendedIngredients: [
      {
        ...
        measures: {
          metric: { amount: 150, unitLong: "grams", unitShort: "g" },
          us: { amount: 5.3, unitLong: "oz", unitShort: "oz" },
        },
        name: "rice noodles",
        original: "150g rice noodles",
      ...
      },
      {
        ...
        measures: {
          ...
          us: { amount: 2, unitLong: "cloves", unitShort: "cloves" },
        },
        name: "garlic",
    ...
    summary:
      "Classic Thai stir-fried noodles with shrimp, garlic, onion, and eggs.",
    winePairing: null,
  },
  {
    id: 4,
    ...
    extendedIngredients: [
      {
        ...
        measures: {
          metric: { amount: 300, unitLong: "grams", unitShort: "g" },
          us: { amount: 10.6, unitLong: "oz", unitShort: "oz" },
        },
        name: "ground beef",
      ...
      },
      {
        ...
        image: "tortilla.jpg",
        measures: {
          metric: { amount: 8, unitLong: "pieces", unitShort: "pcs" },
          us: { amount: 8, unitLong: "pieces", unitShort: "pcs" },
        },
        name: "taco shells",
        original: "8 taco shells",
        originalName: "taco shells",
        unit: "pcs",
      },
    ],
    summary:
      "Mexican-style beef tacos served with tomatoes, onions, and fresh taco shells.",
    winePairing: null,
  },
  {
    id: 5,
    ...
    extendedIngredients: [
      {
        ...
        image: "couscous.jpg",
        measures: {
          metric: { amount: 250, unitLong: "grams", unitShort: "g" },
          us: { amount: 8.8, unitLong: "oz", unitShort: "oz" },
        },
        name: "couscous",
        original: "250g couscous",
      ...
      },
      {
        ...
        image: "cumin.jpg",
        measures: {
          metric: { amount: 1, unitLong: "tsp", unitShort: "tsp" },
          us: { amount: 1, unitLong: "tsp", unitShort: "tsp" },
        },
        name: "cumin",
      ...
      },
      {
        ...
        image: "carrot.jpg",
        measures: {
          metric: { amount: 2, unitLong: "", unitShort: "" },
          us: { amount: 2, unitLong: "", unitShort: "" },
        },
        name: "carrots",
    ...
    extendedIngredients: [
      ...
      },
      {
        ...
        measures: {
          ...
          us: { amount: 1, unitLong: "cloves", unitShort: "cloves" },
        },
        name: "garlic",
      ...
      },
      {
        ...
        measures: {
          ...
          us: { amount: 1, unitLong: "bunch", unitShort: "bunch" },
        },
        name: "parsley",
        original: "1 bunch fresh parsley",
      ...
      },
      {
        ...
        image: "pita.jpg",
        measures: {
          metric: { amount: 2, unitLong: "pieces", unitShort: "pcs" },
          us: { amount: 2, unitLong: "pieces", unitShort: "pcs" },
        },
        name: "pita bread",
        original: "2 pita breads",
        originalName: "pita breads",
        unit: "pcs",
      },
    ],
    summary:
      "Middle Eastern falafel wraps with chickpeas, parsley, and garlic.",
    winePairing: null,
  },
  {
    id: 7,
    ...
    extendedIngredients: [
      ...
      },
      {
        ...
        image: "pancetta.jpg",
        measures: {
          metric: { amount: 80, unitLong: "grams", unitShort: "g" },
          us: { amount: 2.8, unitLong: "oz", unitShort: "oz" },
        },
        name: "pancetta",
        original: "80g pancetta, diced",
      ...
      },
      {
        ...
        image: "parmesan.jpg",
        measures: {
          metric: { amount: 50, unitLong: "grams", unitShort: "g" },
          us: { amount: 1.8, unitLong: "oz", unitShort: "oz" },
        },
    ...
    summary:
      "Classic creamy spaghetti carbonara with eggs, pancetta, and parmesan.",
    winePairing: null,
  },
  {
    id: 8,
    ...
    summary:
      "Healthy Greek salad with tomatoes, cucumbers, feta, and olive oil.",
    winePairing: null,
  },
  {
    id: 9,
    ...
    extendedIngredients: [
      ...
      },
      {
        ...
        image: "olive-oil.jpg",
        measures: {
          metric: { amount: 3, unitLong: "tbsp", unitShort: "tbsp" },
          us: { amount: 3, unitLong: "tbsp", unitShort: "tbsp" },
        },
        name: "olive oil",
    ...
    summary:
      "French onion soup with caramelized onions, bread, and cheesy topping.",
    winePairing: null,
  },
  {
    id: 10,
    ...
    extendedIngredients: [
      ...
      },
      {
        ...
        measures: {
          ...
          us: { amount: 2, unitLong: "slices", unitShort: "slices" },
        },
        name: "cheddar cheese",
      ...
      },
      {
        ...
        image: "lettuce.jpg",
        measures: {
          metric: { amount: 1, unitLong: "leaf", unitShort: "leaf" },
          us: { amount: 1, unitLong: "leaf", unitShort: "leaf" },
        },
        name: "lettuce",
        original: "1 leaf lettuce",
        originalName: "lettuce",
        unit: "leaf",
      },
    ],
    summary:
      "American-style beef cheeseburger with cheddar, lettuce, and fresh buns.",
    winePairing: null,
  },
];

export const ingredientsMock: IngredientInterface[] = [
  {
    aisle: "Meat",
    amount: 500,
    consistency: "solid",
